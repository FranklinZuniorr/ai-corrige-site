...
import { Button, Container, Divider, Grid, Header, Label, List, Message, Segment } from "semantic-ui-react";
...
setViewMoreDetails
    ...
    return(
        <>
            <Segment size="mini">
                <Header content={`Valor de cada questão: ${valueOfQuestion}`} subheader={`Nível: ${textValueOfQuestion}`}/>
                <Divider />
                ...
                } <Message content={`Nota obtida: ${noteObtained}`} />
            </Segment>
        </>
    );
};
